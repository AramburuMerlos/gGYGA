...
dir.create("data/crop_specific/5min", F, T)
...
gdd <- rast("data/climate/wc2.1_5m/mgdd.tif")
...
for(i in seq_along(crops)) {
  ...
  # (days, month, etc.)
  r_plan <- rast(paste0("data/crop_calendar/5min/", crops[i], "_plant_day.tif"))
  r_harv <- rast(paste0("data/crop_calendar/5min/", crops[i], "_harvest_day.tif"))
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_prec_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_prec_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_prec_3.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_srad_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_srad_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_srad_3.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_tavg_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_tavg_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/", crops[i], "_tavg_3.tif"),
    overwrite = TRUE,
...
r_plan <- rast("data/crop_calendar/5min/rice_plant_day.tif")
r_harv <- rast("data/crop_calendar/5min/rice_harvest_day.tif")
...
for(i in seq_len(nlyr(r_plan))) {
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_prec_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_prec_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_prec_3.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_srad_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_srad_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_srad_3.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_tavg_1.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_tavg_2.tif"),
    overwrite = TRUE,
  ...
  writeRaster(
    r,
    filename = paste0("data/crop_specific/5min/rice_s", i, "_tavg_3.tif"),
    overwrite = TRUE,
...
for(i in seq_along(bars)) {
  for(j in 1:3){
    ...
    app(r, mean, na.rm = TRUE,
        filename = paste0("data/crop_specific/5min/", out_name, ".tif"),
        overwrite = TRUE,
